...
class RegisterOlheiroFinalScreen extends StatefulWidget {
  const RegisterOlheiroFinalScreen({super.key});

  @override
  State<RegisterOlheiroFinalScreen> createState() =>
      _RegisterOlheiroFinalScreenState();
}

class _RegisterOlheiroFinalScreenState
    extends State<RegisterOlheiroFinalScreen> {
  ...
  void initState() {
    super.initState();
    _clubeController.addListener(_refreshForm);
                      ...
                      children: [
                        ...
                        RegisterFormPanel(
                          ...
                          child: Column(
                            ...
                            children: [
                              RegisterInputField(
                                label: 'Clube/Organização (Opcional)',
